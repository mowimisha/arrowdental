          ...
          <div class="container-fluid">
              <div class="row bg-title">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                      <h4 class="page-title">Create Publication</h4> </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  <form action="/create_publications" method="post" style="padding: 10px 0 50px 0;" enctype="multipart/form-data">
                    {{ csrf_field() }}
