...
@section ('content')
	...
	<div id="main-carousel-id" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item">
				<img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="../images/s1.jpg">
				<!-- <div class="container">
			...
			<div class="item">
				<img data-src="holder.js/900x500/auto/#666:#6a6a6a/text:Second slide" alt="Second slide" src="../images/s2.jpg">
				<div class="container">
					<!-- <div class="carousel-caption">
			...
			<div class="item active">
				<img data-src="holder.js/900x500/auto/#555:#5a5a5a/text:Third slide" alt="Third slide" src="../images/s3.jpg">
				<!-- <div class="container">
					<div class="carousel-caption">
	...
	<section id="about" class="section">
	  ...
	  <div class="container">
	      <div class="row">
	        <div class="col-md-7">
	            <h3>KARIBU NAIROBI PREMIER DENTAL CLINIC</h3>
	            <hr>
	            <p class="sub">WE ARE INDEED A ONE STOP MEDICAL CENTRE FOR ALL YOUR DENTAL HEALTH ISSUES.</p>
	            <p>Nairobi Premier Dental Clinic is a multi-specialty dental clinic in Nairobi offering a whole wide array of affordable dental cares services to different clients within Nairobi and its environs. Our good dentists are committed to providing top quality dental care in a friendly, comfortable center. We strive to give each of our patients a beautiful smile that they can be proud of, because a beautiful and lasting smile is dependent on sound oral health..</p>
				
				<h3>NEW DENTAL TECHONOLOGY</h3>
				<hr>
	            <p>We strive to give each of our patients a beautiful smile that they can be proud of, because a beautiful and lasting smile is dependent on sound oral health. In line with this, we have invested in great technology to make sure that your get that beautiful smile!</p>

	            <a href="#" target="_blank" class="btn btn-primary about_btn">&nbsp;&nbsp;Our Treatments&nbsp;&nbsp;</a>
	        </div>
	...
	<section id="services">
		<div class="container">
			...
			<div class="blog">
				<div class="row">	
					<div class="col-md-6">
						<h1 class="blog-title">Treatments</h1>
					</div>
				</div>
			...
			<div class="blog">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<img src="../images/doc.jpeg" alt="">
						<div class="name-plate">
							<p class="title text-center">Dr Mike</p>
							<p class="desc text-center">Dental Surgeon</p>
						</div>
					</div>

					<div class="col-md-4">
						
						<img src="../images/loui2.jpeg" alt="">
						<div class="name-plate">
				...
				<div class="blog">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="">
								<p class="title"><a href="#">Top Parenting Hacks To Raising Kids With Good Oral Habits </a></p>
								<p>Whether you just can’t seem to get your children to follow a healthy brushing routine or you’re constantly running out of supplies, raising kids to have good oral habits can feel like an uphill battle.</p>
							</div>
